# Vorträge Magdeburger Developer Days - MDJoerg

Dieses Repository enthält Unterlagen und zusätzliche Informationen zu meinen Vorträgen auf den [Magdeburger Developer Days](https://www.md-devdays.de). 

## 2026

### KI Workshop "Headless Apps"

- Informationen zum Workshop: https://www.brandeis.de/blog/ki-workshop-mdd26
- Die Workshop-Unterlagen stehen nur den Teilnehmern über das Brandeis Trainingsportal zur Verfügung
...
### Vortrag "Brücken bauen mit Cloud-nativen Containern"

- [MDD Session](https://md-devdays.de/act-details/1000411?tabIndex=2)
- [Mein Vortrag](mdd24/202405_MDD.pdf)
- Github Projekt [B-Tocs Python API Template for SAP ABAP](https://github.com/b-tocs/pyapi4abap)
- Github Projekt [B-Tocs ABAP SDK](https://github.com/b-tocs/abap_btocs_core)
